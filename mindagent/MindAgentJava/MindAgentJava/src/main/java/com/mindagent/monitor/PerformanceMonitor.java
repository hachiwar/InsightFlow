...
public class PerformanceMonitor {
    ...
    private final MindAgentProperties properties;
    ...
    public PerformanceMonitor(AgentOrchestrator orchestrator, KnowledgeToolManager toolManager, MindAgentProperties properties, MeterRegistry meterRegistry) {
        this.orchestrator = orchestrator;
        this.toolManager = toolManager;
        this.properties = properties;
        Gauge.builder("mindagent_agent_success_rate", () -> agentSuccessRate).register(meterRegistry);
        this.monitorCollections = Counter.builder("mindagent_monitor_collections_total").register(meterRegistry);
        this.monitorCollectionTimer = Timer.builder("mindagent_monitor_collection_duration").register(meterRegistry);
    }
